  ...
  return (
    <div id="AboutMe">
      <WideContainer>
        ...
        >
          <Typography variant="subtitle1" className={classes.description}>
            I am a third year student in Carleton University's Computer Science
            Honours program with a minor in psychology. I am currently working
            from home in Toronto and I am seeking internship opportunities for
            the 2021 Fall co-op term.
          </Typography>
        </AboutBlock>
      </WideContainer>
      ...
      <WideContainer variant="grey">
        ...
        >
          <Typography variant="subtitle1" className={classes.description}>
            Incoming Software Developer Engineer intern at{" "}
            <a
              className={classes.a}
            ...
            under the Devices organization.
          </Typography>
        </AboutBlock>
      </WideContainer>
